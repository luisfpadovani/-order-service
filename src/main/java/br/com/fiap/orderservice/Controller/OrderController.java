...
public class OrderController {
    ...
    public ResponseEntity<Order> findById(@PathVariable(value="idOrder", required=true) int idOrder){
    ...
    public ResponseEntity<Order> delete(@PathVariable(value="idOrder", required=true) int idOrder){
